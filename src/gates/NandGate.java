...
public class NandGate extends LogicGate {
	...
	public NandGate(Point location) {
		super(location);
	...
	private static void drawGateBody(Graphics2D g2d) {
		g2d.drawLine(15, 10, 15, 90);
		g2d.drawLine(15, 10, 40, 10);
		g2d.drawLine(15, 90, 40, 90);
		g2d.drawArc(0, 10, 75, 80, 90, -180);
	...
	@Override
	public void update() {
		boolean[] outputSignal = new boolean[Math.max(input1.getSignalWidth(), input2.getSignalWidth())];
	...
	public JDialog getEditDialog(JFrame owner) {
		JDialog dialog = new JDialog(owner, "Edit NAND Gate", true);
